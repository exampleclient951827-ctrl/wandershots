...
USER_TOKEN = "EAAU7OCuAobkBRWDrGfbgoVyrYjhGHab3MqJvfExZBRcuWRyhLLUt6bOhtb1rGteybZCmZBZALwIPgvKShzZAgzDbgZArZAiy094xOw7dHqT8Muqu4ZAEtfJ1Yr4j9wbwRFPLK10XdqeRGZBvVjU5RUviZAhfz18z57Q9XXvZCNmmalghoznmDkkMo9RhPfU5tNZBxV63"
PAGE_ID    = "1025389933991966"
...
caption = (
    "🌾 SYSTEM CHECK — Wandershots Auto-Post ✅\n\n"
    "Automated test from the Wandershots system.\n"
    "If you see this on your Page, posting is WORKING! 🎉\n\n"
    "#Photobooth #wandershots #Philippines"
)
...
if "id" in r:
    ...
    fixes = {
        10:  "App is in DEVELOPMENT mode.\n"
             "     Fix: developers.facebook.com -> app 'Wandershots' -> toggle to LIVE mode",
